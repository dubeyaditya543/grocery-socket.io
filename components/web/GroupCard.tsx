...
export async function GroupCard({ group }: GroupCardProps) {
  ...
  return (
    <div className="flex flex-col justify-between rounded-2xl border border-slate-200/80 bg-white p-5 shadow-xs transition-all duration-200 hover:shadow-md hover:cursor-pointer">
      ...
      <div className="space-y-1.5">
        <div className="flex items-start justify-between gap-2">
          ...
          <button className="-mr-1 rounded-lg p-1 text-slate-400 transition hover:bg-slate-100 hover:text-slate-600">
      ...
      <div className="my-4 flex items-center">
        <div className="flex -space-x-2 px-2 py-2 overflow-hidden">
